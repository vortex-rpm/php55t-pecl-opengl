...
%global pecl_name opengl
%global real_name opengl

Summary: Extension to write OpenGL with PHP
Name: %{php_base}-pecl-opengl
Version: 0.8.0
...
BuildRequires: %{php_base}-devel, %{php_base}-cli, %{php_base}-pear, mesa-libGL-devel, mesa-libGLU-devel
...
%description
This extension allows you to develop 3D multimedia applications with
PHP using the complete OpenGL library API.
...
%changelog
* Wed Aug 27 2014 Ilya Otyutskiy <ilya.otyutskiy@icloud.com> - 0.8.0-1.vortex
- Initial release.
